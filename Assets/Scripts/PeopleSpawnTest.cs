...
public class PeopleSpawnTest : MonoBehaviour
{
    ...
    {
        int obstacleIndex = Random.Range(0, peoplePrefab.Length);
        ...
        Instantiate(peoplePrefab[obstacleIndex], spawnPos, spawnRot);
